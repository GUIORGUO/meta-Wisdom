          ...
          <el-row :gutter="2" style="margin-left: 45px">
            <el-col :span="7" :offset="1">
              <h1 id="header" title="MARVEL(奇迹实验室)">
                <a
                  ...
                  eid="click/navi/logo"
                  eid_desc="点击/导航/logo"
                  style="color: #63c5ff; text-decoration-line: none"
                >
            ...
            <div class="daohang" style="margin-top: 27px; margin-left: -100px">
              ...
              <el-col :span="8">
                <div class="hy-nav-item">
                  <a
                    class="hy-nav-link hy-nav-link-ext clickstat"
                    id="hy-nav-category"
                    eid="click/navi/classification"
                    eid_desc="点击/导航/分类"
                    href=""
                    style="color: #4eb6ff"
                    >分类<i></i
           ...
           <el-col span="6">
            ...
            <el-row :gutter="2" type="flex" justify="center">
              ...
              <el-col :xs="12" :ms="24" :md="24" :lg="6" :xl="8">
                ...
                <dv-border-box-12 style="min-width: 350px; height: 340px">
          ...
          <div class="flv-box" style="margin-left: 50px">
            ...
            <el-row :span="24" style="margin-top: 10px">
              <el-col :span="8" :offset="1">
                <dv-decoration-7
                  style="margin-top: 20px; width: 150px; height: 30px"
                  class="name1"
                  >精彩推荐</dv-decoration-7
                >
              </el-col>
            </el-row>
            <!-- 第一行视频 -->
                ...
                <dv-border-box-1 style="height: 280px; width: 370px">
                  <div>
                    <video
                      ...
                      autoplay
                      muted
                      style="height: 201px; width: 340px"
                    ></video>
                    <div style="margin-top: -20px; padding: 0px">
                      <el-row :span="18">
                        <el-col :span="10">
          ...
          <el-row :span="24" type="flex" justify="center" :gutter="2">
            ...
            <el-col :span="8">
              ...
              >
                <div>
                  <dv-decoration-7
                    style="padding-top: 20px; width: 200px; height: 30px"
                    class="name1"
                    >精彩直播间</dv-decoration-7
                  >
                  <dv-scroll-board
                    :config="config1"
                    style="
                  ...
                  <div style="">
                    ...
                    <div class="DyRecCover-content">
                      <div>
                        ...
                        <h3 class="DyRecCover-intro" title="Tpp天花老年版">
                          Tpp天花老年版
                        </h3>
                      </div>
              ...
              <el-col :span="6">
                <dv-border-box-8 style="width: 320px; height: 260px">
                  ...
                  >
                    <img
                      class="img1"
                      src="https://rpic.douyucdn.cn/live-cover/roomCover/cover_update/2021/07/16/881343dfe97b2a848b32784d3689fdf0.jpg/dy1"
                      alt=""
                      style="max-width: 100%; height: 100%"
                    />
                    <div class="DyRecCover-info">
              ...
              <el-col :span="6">
                <dv-border-box-8 style="width: 320px; height: 260px">
                  <div class="img-wrapper" style="margin-top: 20px">
                    <img
                      class="img1"
                      src="https://rpic.douyucdn.cn/asrpic/211214/787579_1127.png/dy1"
                      alt=""
                      style="max-width: 100%; height: 100%"
                    />
                    <div class="DyRecCover-info">
              ...
              <el-col :span="6">
                <dv-border-box-8 style="width: 320px; height: 260px">
                  ...
                  >
                    <img
                      class="img1"
                      src="https://rpic.douyucdn.cn/asrpic/211214/101367_1126.png/dy1"
                      alt=""
                      style="max-width: 100%; height: 100%"
                    />
                    <div class="DyRecCover-info">
              ...
              <el-col :span="6">
                <dv-border-box-8 style="width: 320px; height: 260px">
                  ...
                  >
                    <img
                      class="img1"
                      src="https://rpic.douyucdn.cn/asrpic/211214/6462960_1127.png/dy1"
                      alt=""
                      style="max-width: 100%; height: 100%"
                    />
                    <div class="DyRecCover-info">
                ...
                <dv-border-box-8 style="width: 320px; height: 260px">
                  <div style="">
                    ...
                    >
                      <img
                        class="img1"
                        src="https://rpic.douyucdn.cn/asrpic/211214/2459142_1127.png/dy1"
                        alt=""
                        style="max-width: 100%; height: 100%"
                      />
                      <div class="DyRecCover-info">
                ...
                <dv-border-box-8 style="width: 320px; height: 260px">
                  <div style="">
                    ...
                    >
                      <img
                        class="img1"
                        src="https://rpic.douyucdn.cn/live-cover/roomCove_coverUpdate_2021-11-18_526eba1f108e60a9d9e6f5ae1ad08b0c.jpg/dy1"
                        alt=""
                        style="max-width: 100%; height: 100%"
                      />
                      <div class="DyRecCover-info">
...
.DyRecCover-info {
  ...
  background-image: -moz-
    oldlinear-gradient(top, transparent 0, rgba(0, 0, 0, 0.65) 100%);
