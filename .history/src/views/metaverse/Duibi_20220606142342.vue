...
<!-- 柱状图 -->
  <div class="Woman" >
   ...
   <el-row type="flex" justify="center" >
       <el-col :span="24">
            <div id="duibi" :data="option13" :style="{ minwidth: '340px', minHeight: '800px'}"></div>
      </el-col>
   </el-row>
   </div>
</template>
     ...
     setup() {
        ...
        onMounted(() => {
                ...
                return {
                    ...
                    yAxis: {
                    data: ['数体质量', '运行时间', 'CPU负载', 'jie shou shu ju bao', 'car'],
                    inverse: true,
                    axisLine: { show: false },
                    axisTick: { show: false },
                    axisLabel: {
                ...
                var optionIndex = 0;
                var option13 = options[optionIndex];
                ...
                myChart.setOption(options[optionIndex]);
                  ...
                  let myChart = echarts.init(document.getElementById("duibi"));
                  //指定配置项和数据显示
